 ...
 * @author m0nsterdev
 * @updateUrl https://raw.githubusercontent.com/m0nsterdev.BetterMessageLinks.plugin.js
 * @authorLink https://github.com/M0nsterdev
 * @source https://github.com/m0nsterdev/BetterMessageLinks.plugin.js
 * @invite VHPjBhkxHb
 */
const config = {
	"info": {
		...
		"github_raw": "https://raw.githubusercontent.com/m0nsterdev/BetterMessageLinks.plugin.js",
	},
	"changelog": [
		{
			"title": "First",
			"type": "First model",
			"items": [
				"Thanks to alot of editting and alot of sweat and time im glad to present this plugin ",
